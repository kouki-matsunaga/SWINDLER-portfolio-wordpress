...
<header class="en">
  ...
  <nav class="container navbar navbar-expand-lg navbar-light">
    <a class="navbar-brand" href="<?php echo $slash; ?>#"><img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/img/logo.svg" alt="SWINDLER"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo $slash; ?>#section-services">SERVICES</a>
        </li>
        <li class="nav-item">
